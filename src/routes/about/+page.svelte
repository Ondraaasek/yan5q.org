<script>
  ...
  <div class="layout">
    ...
    <main class="container">
      <section class="intro">
        <h1 class="fade-in">About Me - ! UNFINISHED !</h1>
        <p class="intro-text fade-in">
          I'm a cybersecurity student passionate about technology and coding. 
          Currently focusing on learning C# and exploring various aspects of software development. - all the text on this page was generated by ai, ill fix it soon (abt 6 months)
        </p>
      </section>
